...
package io.github.firstred.iptvproxy.plugins.ktor.client
...
private class FileCacheStorage(
    ...
    private suspend fun readCache(channel: ByteReadChannel): CachedResponseData {
        ...
        (0 until headersCount).forEach { j ->
    ...
    companion object {
        val LOGGER = LoggerFactory.getLogger("FileCacheStorage")
    }
}
